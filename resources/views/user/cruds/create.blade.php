                ...
                <section class="bd_edit-profile-stack shadow-md p-8 flex flex-col text-center lg:text-start lg:flex-row lg:gap-2">
                    ...
                    <div class="w-full mt-4 lg:w-2/4 lg:mt-0">
                        ...
                        <div class="w-full min-w-[200px] mt-4">
                            ...
                            <input type="text" id="personal_address" class="bg-bd_secondary-color border-2 border-bd_primary-color text-gray-900 placeholder-gray-400 text-sm rounded-lg focus:ring-bd_primary-color dark:bg-gray-700 focus:border-bd_primary-color block w-full p-2.5"
                                placeholder="Via Roma 50, 26900" name="personal_address" value="{{ old('personal_address')}}">
                    ...
                    <div class="w-full mt-4 lg:w-2/4 lg:mt-0">
                        <div class="lg:flex lg:gap-4">
                            ...
                            <div class="w-full lg:w-1/2 min-w-[200px] mt-4 lg:mt-0">
                                ...
                                <input type="text" id="phone_number" class="bg-bd_secondary-color border-2 border-bd_primary-color text-gray-900 placeholder-gray-400 text-sm rounded-lg focus:ring-bd_primary-color dark:bg-gray-700 focus:border-bd_primary-color block w-full p-2.5"
                                    placeholder="341 010 1010" name="phone_number" value="{{ old('phone_number')}}">
                                <div class="lg:hidden">
                        ...
                        <div class="w-full min-w-[200px] mt-4">
                            ...
                            <input type="text" id="work_address" class="bg-bd_secondary-color border-2 border-bd_primary-color text-gray-900 placeholder-gray-400 text-sm rounded-lg focus:ring-bd_primary-color dark:bg-gray-700 focus:border-bd_primary-color block w-full p-2.5"
                                placeholder="Via delle Industrie, 67000, Como" name="work_address" value="{{ old('work_address')}}">
                        ...
                        <div class="w-full min-w-[200px] mt-4">
                            ...
                            <input type="text" id="performance" class="bg-bd_secondary-color border-2 border-bd_primary-color text-gray-900 placeholder-gray-400 text-sm rounded-lg focus:ring-bd_primary-color focus:border-bd_primary-color block w-full p-2.5"
                                placeholder="Visita di controllo..." name="performance" value="{{ old('performance')}}">
